...
#[allow(dead_code)]
pub fn day182(input : &String) -> () {
	println!("Part1: {}", day182_1(input));
	println!("Part2: {}", day182_2(input));
}

pub fn day182_1(input : &String) -> u64 {
...
pub fn day182_2(input : &String) -> u64 {
...
mod tests {
	...
	fn test182_1() {
		...
		assert_eq!(4140, day182_1(&input));
	}

	#[test]
	fn test182_2() {
		let input = &String::from("[[[0,[5,8]],[[1,7],[9,6]]],[[4,[1,2]],[[1,4],2]]]\n[[[5,[2,8]],4],[5,[[9,9],0]]]\n[6,[[[6,2],[5,6]],[[7,6],[4,7]]]]\n[[[6,[0,7]],[0,9]],[4,[9,[9,0]]]]\n[[[7,[6,4]],[3,[1,3]]],[[[5,5],1],9]]\n[[6,[[7,3],[3,2]]],[[[3,8],[5,7]],4]]\n[[[[5,4],[7,7]],8],[[8,3],8]]\n[[9,3],[[9,9],[6,[4,9]]]]\n[[2,[[7,7],7]],[[5,8],[[9,3],[0,2]]]]\n[[[[5,2],5],[8,[3,7]]],[[5,[7,5]],[4,4]]]\n");
		assert_eq!(3993,day182_2(input));
	}
}